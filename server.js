...
// ==================== [ 9. ระบบแอดมินยืนยันผลคำนวณเงินจริง OK / NO (Settlement Engine) ] ====================
    ...
    // ==================== [ 10. ระบบคู่มือ: คำสั่งสำหรับสมาชิก (คส) และ กติกา (กต) ] ====================
            else if (userMsg === 'คส' || userMsg === 'กต') {
                if (userMsg === 'คส') {
                    replyText = `📜 **[ คู่มือคำสั่งสำหรับสมาชิกทุกท่าน ]** 📜\n\n` +
                                `🔹 **c** (พิมพ์ตัว c เล็กตัวเดียว) ➡️ เช็กเลขสมาชิก ยอดเครดิตปัจจุบัน และโพยที่แทงค้างไว้ในรอบนั้น\n` +
                                `🔹 **[เลขขา]-[จำนวนเงิน]** ➡️ ส่งโพยเดิมพัน (เช่น 123-100 คือแทงขา 1, 2, 3 ขาละ 100 บาท)\n` +
                                `🔹 **มข-[จำนวนเงิน]** ➡️ แทงเหมาหมดทุกขา ขาละเท่าๆ กัน (เช่น มข-50คือแทงขา 1 ถึง 6 ขาละ 50 บาท)\n` +
                                `🔹 **ม0-[จำนวนเงิน]** ➡️ แทงเจ้ามือชนผู้เล่นทุกขา ขาละเท่าๆ กัน (เช่น มจ-50คือแทงเจ้ามือชนขา 1 ถึง 6 ขาละ 50 บาท)\n` +
                                `🔹 **r** (พิมพ์ตัว r เล็กตัวเดียว) ➡️ ขอดึงโพยคืน/ยกเลิกโพยทั้งหมดในรอบนั้น (ใช้ได้เฉพาะตอนที่ยังไม่ปิดรอบแทง)\n` +
                                `🔹 **[เลขขา]+** ➡️ ขอจั่วไพ่ใบที่ 3 เพิ่มเติมในขานั้นๆ (เช่น 12+ คือขอจั่วขา 1 และขา 2 เพิ่ม *ใช้ได้ตอนเปิดรอบจั่วเท่านั้น*)\n\n` +
                                `💡 *หมายเหตุ: ทุกคำสั่งสามารถพิมพ์ได้ทั้งตัวพิมพ์เล็กและตัวพิมพ์ใหญ่ครับ*`;
                } 
                else if (userMsg === 'กต') {
                    // ✍️ ตรงนี้คือจุดที่ฉันเตรียมไว้ให้คุณมาเขียนอธิบายกติกาเองได้ตามใจชอบเลยครับ
