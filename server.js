...
let isDrawOpen = false;  // บรรทัดนี้เพื่อเช็กสถานะรอบจั่วไพ
        ...
        if (event.type === 'message' && event.message.type === 'text') {
            ...
            if (command === "เติม" || command === "ลบ") {
                ...
                if (userId !== ADMIN_ID) {
                    ...
                    // เช็กว่าพิมพ์คำสั่งครบและถูกต้องไหม
                    if (!targetMemberId || isNaN(amount) || amount <= 0) {
                        ...
                        // วนลูปหา LINE User ID จากเลขสมาชิกที่ระบุมา
                        ...
                        // ถ้าไม่เจอเลขสมาชิกในระบบ
                        if (!foundUserKey) {
                            replyText = `❌ ไม่พบเลขสมาชิกที่ ${targetMemberId} ในระบบครับ`;
                        } else {
                            // คิดคำนวณเงินและปรับปรุงยอดในระบบ
                            if (command === "เติม") {
            ...
            // ==================== [ 5. โค้ดระบบคืนโพย / ยกเลิกโพยในรอบ ] ====================
            else if (userMsg === "r") {
                if (!isRoundOpen) {
