    ...
    if (!isHiloRoundOpen) {
        ...
        if (!isRegistered) {
            ...
            const MAX_BET_MAP = {
                "ส/ต": 150,        // สูง / ต่ำ
                "11": 20,         // 11 ไฮโล
                "เต็ง": 150,        // เต็งเลข (คิดต่อ 1 หน้า)
                "โต๊ด2": 30,       // โต๊ด 2 ตัว
                "โต๊ด3": 100,      // โต๊ด 3 ตัว
                "คู่ส/ต": 50,      // สูง/ต่ำ + เลข (เช่น ต1, ส6)
                "ตองรวม": 10,      // ตองรวม / ตองใดๆ (ตอง)
...
hiloList.forEach((hBet) => {
    ...
    // 3️⃣ เต็งหน้า 1 ถึง 6 (เช่น target: "1", "2")
    ...
    // 4️⃣ โต๊ด 2 ตัว (เช่น target: "23", "45", "1-2")
    ...
    // 5️⃣ โต๊ด 3 ตัว (เช่น target: "234", "1-2-3")
    ...
    // 8️⃣ ต่ำ + หน้าเต๋า (เช่น target: "ต1", "ต2", "ต3")
    ...
    // 9️⃣ สูง + หน้าเต๋า (เช่น target: "ส6", "ส5")
